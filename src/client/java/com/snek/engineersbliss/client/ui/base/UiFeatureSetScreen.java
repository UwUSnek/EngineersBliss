...
public class UiFeatureSetScreen extends UiSidebarScreen {
    ...
    protected void init() {
        ...
        final UiTxt titleText = new UiTxt(featureSet.getName().get(), 2f);
    ...
    protected void onFeatureHoverChange(final @Nullable FeatureInputWidget newWidget) {
        ...
        // Show feature info UI otherwise
            ...
            // Feature name
            final UiTxt nameText = new UiTxt(newWidget.getClientFeature().getName().get(), 2f);
            ...
            final UiTxt descriptionText = newWidget.getClientFeature().getDesc();
