...
public class UiToggleButton extends UiButton {
    ...
    public void extractBackground(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float a) {
        ...
        if(value) {
            graphics.fill(getRight() - INDICATOR_WIDTH, getY(), getRight(), getBottom(), getBgBaseColorAlt());
        }
    }

    public void recalculateBgColor() {
        setBgColor(getValue() ? Layout.bgColorAlt : Layout.bgColor);
    }
}
