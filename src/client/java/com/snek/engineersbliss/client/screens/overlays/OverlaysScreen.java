...
public class OverlaysScreen extends __base_UiFeatureSetScreen {
    ...
    protected void init() {
        ...
        leftSidebar.addWidget(new UiTextWidget(new UiTxt("Power levels", Fonts.ui.light, Layout.HEADER_SCALE), TextAlignment.LEFT, Layout.fgColor), Layout.HEADER_HEIGHT);
        ...
        // Logic
        leftSidebar.addWidget(new UiSpacer(), Layout.BIG_SEPARATOR_HEIGHT);
        leftSidebar.addWidget(new UiTextWidget(new UiTxt("Block logic", Fonts.ui.light, Layout.HEADER_SCALE), TextAlignment.LEFT, Layout.fgColor), Layout.HEADER_HEIGHT);
