...
public class OverlaysScreen extends UiFeatureSetScreenWithPreview {
    ...
    protected void init() {
        ...
        leftSidebar.addWidget(new UiTextWidget(this, new UiTxt("Power levels", Layout.HEADER_TEXT_SCALE), TextAlignment.LEFT, Layout.fgColor), Layout.HEADER_HEIGHT);
        ...
        // Logic
        leftSidebar.addSpacer(Layout.BIG_SEPARATOR_HEIGHT);
        leftSidebar.addWidget(new UiTextWidget(this, new UiTxt("Block logic", Layout.HEADER_TEXT_SCALE), TextAlignment.LEFT, Layout.fgColor), Layout.HEADER_HEIGHT);
