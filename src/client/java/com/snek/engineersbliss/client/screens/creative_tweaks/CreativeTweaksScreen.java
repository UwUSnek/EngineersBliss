...
public class CreativeTweaksScreen extends __base_UiFeatureSetScreen {
    ...
    protected void init() {
        ...
        leftSidebar.addWidgetAndSpacer(new UiFeatureButton(this, CreativeTweaksClientFeatureSet.PHASE_THROUGH_BLOCKS_FLY),        Layout.BORDER_HEIGHT);
        leftSidebar.addWidgetAndSpacer(new UiFeatureButton(this, CreativeTweaksClientFeatureSet.PHASE_THROUGH_ENTITIES),          Layout.BORDER_HEIGHT);
        leftSidebar.addWidgetAndSpacer(new UiFeatureButton(this, CreativeTweaksClientFeatureSet.DISABLE_FIRE_EFFECT),             Layout.BORDER_HEIGHT);
        leftSidebar.addWidgetAndSpacer(new UiFeatureButton(this, CreativeTweaksClientFeatureSet.DISABLE_FREEZING_EFFECT),         Layout.BORDER_HEIGHT);
        leftSidebar.addWidgetAndSpacer(new UiFeatureButton(this, CreativeTweaksClientFeatureSet.FIX_HONEY_JUMP),                  Layout.BORDER_HEIGHT);
        leftSidebar.addWidgetAndSpacer(new UiFeatureButton(this, CreativeTweaksClientFeatureSet.DISABLE_HONEY_SLIDING),           Layout.BORDER_HEIGHT);
        leftSidebar.addWidgetAndSpacer(new UiFeatureButton(this, CreativeTweaksClientFeatureSet.DISABLE_SLIME_BOUNCE),            Layout.BORDER_HEIGHT);
        leftSidebar.addWidgetAndSpacer(new UiFeatureButton(this, CreativeTweaksClientFeatureSet.DISABLE_BED_BOUNCE),              Layout.BORDER_HEIGHT);
        leftSidebar.addWidgetAndSpacer(new UiFeatureButton(this, CreativeTweaksClientFeatureSet.DISABLE_ICE_SLIDING),             Layout.BORDER_HEIGHT);
        ...
        leftSidebar.addWidgetAndSpacer(new UiFeatureButton(this, CreativeTweaksClientFeatureSet.DISABLE_HONEY_SLOWDOWN),          Layout.BORDER_HEIGHT);
        leftSidebar.addWidgetAndSpacer(new UiFeatureButton(this, CreativeTweaksClientFeatureSet.DISABLE_SLIME_SLOWDOWN),          Layout.BORDER_HEIGHT);
        leftSidebar.addWidgetAndSpacer(new UiFeatureButton(this, CreativeTweaksClientFeatureSet.DISABLE_SOULSAND_SLOWDOWN),       Layout.BORDER_HEIGHT);
        leftSidebar.addWidgetAndSpacer(new UiFeatureButton(this, CreativeTweaksClientFeatureSet.DISABLE_POWDER_SNOW_SLOWDOWN),    Layout.BORDER_HEIGHT);
        leftSidebar.addWidgetAndSpacer(new UiFeatureButton(this, CreativeTweaksClientFeatureSet.DISABLE_WATER_SLOWDOWN),          Layout.BORDER_HEIGHT);
        leftSidebar.addWidgetAndSpacer(new UiFeatureButton(this, CreativeTweaksClientFeatureSet.DISABLE_LAVA_SLOWDOWN),           Layout.BORDER_HEIGHT);
        leftSidebar.addWidgetAndSpacer(new UiFeatureButton(this, CreativeTweaksClientFeatureSet.DISABLE_COBWEB_SLOWDOWN),         Layout.BORDER_HEIGHT);
        leftSidebar.addWidgetAndSpacer(new UiFeatureButton(this, CreativeTweaksClientFeatureSet.DISABLE_LADDER_SLOWDOWN),         Layout.BORDER_HEIGHT);
        leftSidebar.addWidgetAndSpacer(new UiFeatureButton(this, CreativeTweaksClientFeatureSet.DISABLE_VINES_SLOWDOWN),          Layout.BORDER_HEIGHT);
        ...
        leftSidebar.addWidgetAndSpacer(new UiFeatureButton(this, CreativeTweaksClientFeatureSet.DISABLE_WATER_FOV_CHANGE),        Layout.BORDER_HEIGHT);
        leftSidebar.addWidgetAndSpacer(new UiFeatureButton(this, CreativeTweaksClientFeatureSet.DISABLE_WATER_OVERLAY),           Layout.BORDER_HEIGHT);
        leftSidebar.addWidgetAndSpacer(new UiFeatureButton(this, CreativeTweaksClientFeatureSet.DISABLE_LAVA_OVERLAY),            Layout.BORDER_HEIGHT);
        leftSidebar.addWidgetAndSpacer(new UiFeatureButton(this, CreativeTweaksClientFeatureSet.DISABLE_NETHER_PORTAL_OVERLAY),   Layout.BORDER_HEIGHT);
