...
public class AltTexturesScreen extends __base_Screen {
    ...
    protected void init() {
        ...
        addButton(getToggleText(AltTextureFeature.NO_REDSTONE_DUST_PARTICLES),   AltTextureFeature.NO_REDSTONE_DUST_PARTICLES  .getDetails(), b -> toggleFeature(AltTextureFeature.NO_REDSTONE_DUST_PARTICLES,   b), BORDER_WIDTH, LIST_TOP + (BUTTON_HEIGHT + BORDER_HEIGHT) * 1, BUTTON_WIDTH);
        ...
        addButton(getToggleText(AltTextureFeature.NO_FIRE_PARTICLES),            AltTextureFeature.NO_FIRE_PARTICLES           .getDetails(), b -> toggleFeature(AltTextureFeature.NO_FIRE_PARTICLES,            b), BORDER_WIDTH, LIST_TOP + (BUTTON_HEIGHT + BORDER_HEIGHT) * 3, BUTTON_WIDTH);
        addButton(getToggleText(AltTextureFeature.NO_LAVA_PARTICLES),            AltTextureFeature.NO_LAVA_PARTICLES           .getDetails(), b -> toggleFeature(AltTextureFeature.NO_LAVA_PARTICLES,            b), BORDER_WIDTH, LIST_TOP + (BUTTON_HEIGHT + BORDER_HEIGHT) * 4, BUTTON_WIDTH);
        addButton(getToggleText(AltTextureFeature.NO_WATER_STREAM_PARTICLES),    AltTextureFeature.NO_WATER_STREAM_PARTICLES   .getDetails(), b -> toggleFeature(AltTextureFeature.NO_WATER_STREAM_PARTICLES,    b), BORDER_WIDTH, LIST_TOP + (BUTTON_HEIGHT + BORDER_HEIGHT) * 5, BUTTON_WIDTH);
        addButton(getToggleText(AltTextureFeature.NO_DRIP_PARTICLES),            AltTextureFeature.NO_DRIP_PARTICLES           .getDetails(), b -> toggleFeature(AltTextureFeature.NO_DRIP_PARTICLES,            b), BORDER_WIDTH, LIST_TOP + (BUTTON_HEIGHT + BORDER_HEIGHT) * 6, BUTTON_WIDTH);
        addButton(getToggleText(AltTextureFeature.TRANSPARENT_SLIME_BLOCK),      AltTextureFeature.TRANSPARENT_SLIME_BLOCK     .getDetails(), b -> toggleFeature(AltTextureFeature.TRANSPARENT_SLIME_BLOCK,      b), BORDER_WIDTH, LIST_TOP + (BUTTON_HEIGHT + BORDER_HEIGHT) * 7, BUTTON_WIDTH);
        addButton(getToggleText(AltTextureFeature.TRANSPARENT_HONEY_BLOCK),      AltTextureFeature.TRANSPARENT_HONEY_BLOCK     .getDetails(), b -> toggleFeature(AltTextureFeature.TRANSPARENT_HONEY_BLOCK,      b), BORDER_WIDTH, LIST_TOP + (BUTTON_HEIGHT + BORDER_HEIGHT) * 8, BUTTON_WIDTH);
        addButton(getToggleText(AltTextureFeature.UNOBSTRUCTIVE_MANGROVE_ROOTS), AltTextureFeature.UNOBSTRUCTIVE_MANGROVE_ROOTS.getDetails(), b -> toggleFeature(AltTextureFeature.UNOBSTRUCTIVE_MANGROVE_ROOTS, b), BORDER_WIDTH, LIST_TOP + (BUTTON_HEIGHT + BORDER_HEIGHT) * 9, BUTTON_WIDTH);
        addButton(getToggleText(AltTextureFeature.UNOBSTRUCTIVE_SCAFFOLDING),    AltTextureFeature.UNOBSTRUCTIVE_SCAFFOLDING   .getDetails(), b -> toggleFeature(AltTextureFeature.UNOBSTRUCTIVE_SCAFFOLDING,    b), BORDER_WIDTH, LIST_TOP + (BUTTON_HEIGHT + BORDER_HEIGHT) * 10, BUTTON_WIDTH);
        ...
        addButton(               getToggleText(AltTextureFeature.STATIC_BANNERS),               AltTextureFeature.STATIC_BANNERS              .getDetails(), b ->                toggleFeature(AltTextureFeature.STATIC_BANNERS,              b), BORDER_WIDTH + (BORDER_WIDTH + BUTTON_WIDTH) * 1, LIST_TOP + (BUTTON_HEIGHT + BORDER_HEIGHT) * 6, BUTTON_WIDTH);
        addButton(               getToggleText(AltTextureFeature.STATIC_DECORATED_POTS),        AltTextureFeature.STATIC_DECORATED_POTS       .getDetails(), b ->                toggleFeature(AltTextureFeature.STATIC_DECORATED_POTS,       b), BORDER_WIDTH + (BORDER_WIDTH + BUTTON_WIDTH) * 1, LIST_TOP + (BUTTON_HEIGHT + BORDER_HEIGHT) * 7, BUTTON_WIDTH);
        ...
        addButton(               getToggleText(AltTextureFeature.OPTIMIZED_SHELVES),            AltTextureFeature.OPTIMIZED_SHELVES           .getDetails(), b ->                toggleFeature(AltTextureFeature.OPTIMIZED_SHELVES,           b), BORDER_WIDTH + (BORDER_WIDTH + BUTTON_WIDTH) * 1, LIST_TOP + (BUTTON_HEIGHT + BORDER_HEIGHT) * 10, BUTTON_WIDTH);
        addButton(               getToggleText(AltTextureFeature.OPTIMIZED_CAMPFIRES),          AltTextureFeature.OPTIMIZED_CAMPFIRES         .getDetails(), b ->                toggleFeature(AltTextureFeature.OPTIMIZED_CAMPFIRES,         b), BORDER_WIDTH + (BORDER_WIDTH + BUTTON_WIDTH) * 1, LIST_TOP + (BUTTON_HEIGHT + BORDER_HEIGHT) * 11, BUTTON_WIDTH);
        addButton(               getToggleText(AltTextureFeature.OPTIMIZED_LECTERNS),           AltTextureFeature.OPTIMIZED_LECTERNS          .getDetails(), b ->                toggleFeature(AltTextureFeature.OPTIMIZED_LECTERNS,          b), BORDER_WIDTH + (BORDER_WIDTH + BUTTON_WIDTH) * 1, LIST_TOP + (BUTTON_HEIGHT + BORDER_HEIGHT) * 12, BUTTON_WIDTH);
