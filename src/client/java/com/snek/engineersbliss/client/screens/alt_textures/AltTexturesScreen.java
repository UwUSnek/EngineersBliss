...
public class AltTexturesScreen extends __base_Screen {
    ...
    protected void init() {
        ...
        addButton(               getToggleText(AltTextureFeature.STATIC_CHESTS),                AltTextureFeature.STATIC_CHESTS               .getDetails(), b ->                toggleFeature(AltTextureFeature.STATIC_CHESTS,              b), BORDER_WIDTH + (BORDER_WIDTH + BUTTON_WIDTH) * 1, LIST_TOP + (BUTTON_HEIGHT + BORDER_HEIGHT) * 0, BUTTON_WIDTH);
        addButton(               getToggleText(AltTextureFeature.STATIC_SIGNS),                 AltTextureFeature.STATIC_SIGNS                .getDetails(), b ->                toggleFeature(AltTextureFeature.STATIC_SIGNS,               b), BORDER_WIDTH + (BORDER_WIDTH + BUTTON_WIDTH) * 1, LIST_TOP + (BUTTON_HEIGHT + BORDER_HEIGHT) * 0, BUTTON_WIDTH);
