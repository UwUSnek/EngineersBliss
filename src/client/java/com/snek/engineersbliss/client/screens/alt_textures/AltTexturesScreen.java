...
public class AltTexturesScreen extends __base_Screen {
    ...
    protected void init() {
        ...
        addButton(               getToggleText(AltTextureFeature.STATIC_LECTERNS),              AltTextureFeature.STATIC_LECTERNS             .getDetails(), b ->                toggleFeature(AltTextureFeature.STATIC_LECTERNS,             b), BORDER_WIDTH + (BORDER_WIDTH + BUTTON_WIDTH) * 1, LIST_TOP + (BUTTON_HEIGHT + BORDER_HEIGHT) * 10, BUTTON_WIDTH);
        addButton(               getToggleText(AltTextureFeature.OPTIMIZED_SHELVES),            AltTextureFeature.OPTIMIZED_SHELVES           .getDetails(), b ->                toggleFeature(AltTextureFeature.OPTIMIZED_SHELVES,           b), BORDER_WIDTH + (BORDER_WIDTH + BUTTON_WIDTH) * 1, LIST_TOP + (BUTTON_HEIGHT + BORDER_HEIGHT) * 11, BUTTON_WIDTH);
        addButton(               getToggleText(AltTextureFeature.OPTIMIZED_CAMPFIRES),          AltTextureFeature.OPTIMIZED_CAMPFIRES         .getDetails(), b ->                toggleFeature(AltTextureFeature.OPTIMIZED_CAMPFIRES,         b), BORDER_WIDTH + (BORDER_WIDTH + BUTTON_WIDTH) * 1, LIST_TOP + (BUTTON_HEIGHT + BORDER_HEIGHT) * 12, BUTTON_WIDTH);
