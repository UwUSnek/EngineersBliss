...
public class AltTexturesScreen extends __base_Screen {
    ...
    protected void init() {
        ...
        addButton(getToggleText(AltTextureFeature.TRANSPARENT_SLIME_BLOCK),      AltTextureFeature.TRANSPARENT_SLIME_BLOCK     .getDetails(), b -> toggleFeature(AltTextureFeature.TRANSPARENT_SLIME_BLOCK,      b), BORDER_WIDTH, LIST_TOP + (BUTTON_HEIGHT + BORDER_HEIGHT) * 0, BUTTON_WIDTH);
        addButton(getToggleText(AltTextureFeature.TRANSPARENT_HONEY_BLOCK),      AltTextureFeature.TRANSPARENT_HONEY_BLOCK     .getDetails(), b -> toggleFeature(AltTextureFeature.TRANSPARENT_HONEY_BLOCK,      b), BORDER_WIDTH, LIST_TOP + (BUTTON_HEIGHT + BORDER_HEIGHT) * 1, BUTTON_WIDTH);
        addButton(getToggleText(AltTextureFeature.UNOBSTRUCTIVE_MANGROVE_ROOTS), AltTextureFeature.UNOBSTRUCTIVE_MANGROVE_ROOTS.getDetails(), b -> toggleFeature(AltTextureFeature.UNOBSTRUCTIVE_MANGROVE_ROOTS, b), BORDER_WIDTH, LIST_TOP + (BUTTON_HEIGHT + BORDER_HEIGHT) * 2, BUTTON_WIDTH);
        addButton(getToggleText(AltTextureFeature.UNOBSTRUCTIVE_SCAFFOLDING),    AltTextureFeature.UNOBSTRUCTIVE_SCAFFOLDING   .getDetails(), b -> toggleFeature(AltTextureFeature.UNOBSTRUCTIVE_SCAFFOLDING,    b), BORDER_WIDTH, LIST_TOP + (BUTTON_HEIGHT + BORDER_HEIGHT) * 3, BUTTON_WIDTH);

        // Misc //TODO add header
        addButton(getToggleText(AltTextureFeature.MINIMAL_REDSTONE_WIRE),        AltTextureFeature.MINIMAL_REDSTONE_WIRE       .getDetails(), b -> toggleFeature(AltTextureFeature.MINIMAL_REDSTONE_WIRE,        b), BORDER_WIDTH + (BORDER_WIDTH + BUTTON_WIDTH), LIST_TOP + (BUTTON_HEIGHT + BORDER_HEIGHT) * 0, BUTTON_WIDTH);
        addButton(getToggleText(AltTextureFeature.CONSISTENT_SLOPED_RAILS),      AltTextureFeature.CONSISTENT_SLOPED_RAILS     .getDetails(), b -> toggleFeature(AltTextureFeature.CONSISTENT_SLOPED_RAILS,      b), BORDER_WIDTH + (BORDER_WIDTH + BUTTON_WIDTH), LIST_TOP + (BUTTON_HEIGHT + BORDER_HEIGHT) * 1, BUTTON_WIDTH);
        ...
        addButton(getToggleText(AltTextureFeature.DOORS_3D),                     AltTextureFeature.DOORS_3D                    .getDetails(), b -> toggleFeature(AltTextureFeature.DOORS_3D,                     b), BORDER_WIDTH + (BORDER_WIDTH + BUTTON_WIDTH) * 2, LIST_TOP + (BUTTON_HEIGHT + BORDER_HEIGHT) * 7, BUTTON_WIDTH);
        addButton(getToggleText(AltTextureFeature.TRAPDOORS_3D),                 AltTextureFeature.TRAPDOORS_3D                .getDetails(), b -> toggleFeature(AltTextureFeature.TRAPDOORS_3D,                 b), BORDER_WIDTH + (BORDER_WIDTH + BUTTON_WIDTH) * 2, LIST_TOP + (BUTTON_HEIGHT + BORDER_HEIGHT) * 8, BUTTON_WIDTH);
    }
