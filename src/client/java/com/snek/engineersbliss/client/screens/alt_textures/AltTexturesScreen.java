...
public class AltTexturesScreen extends __base_Screen {
    ...
    protected void init() {
        ...
        addButton(getToggleText(AltTextureFeature.UNOBSTRUCTIVE_SCAFFOLDING),    AltTextureFeature.UNOBSTRUCTIVE_SCAFFOLDING   .getDetails(), b -> toggleFeature(AltTextureFeature.UNOBSTRUCTIVE_SCAFFOLDING,    b), BORDER_WIDTH, LIST_TOP + (BUTTON_HEIGHT + BORDER_HEIGHT) * 6, BUTTON_WIDTH);
        ...
        addButton(               getToggleText(AltTextureFeature.STATIC_CAMPFIRES),             AltTextureFeature.STATIC_CAMPFIRES            .getDetails(), b ->                toggleFeature(AltTextureFeature.STATIC_CAMPFIRES,            b), BORDER_WIDTH + (BORDER_WIDTH + BUTTON_WIDTH) * 1, LIST_TOP + (BUTTON_HEIGHT + BORDER_HEIGHT) * 9, BUTTON_WIDTH);
        addButton(               getToggleText(AltTextureFeature.STATIC_COPPER_GOLEM_STATUES),  AltTextureFeature.STATIC_COPPER_GOLEM_STATUES .getDetails(), b ->                toggleFeature(AltTextureFeature.STATIC_COPPER_GOLEM_STATUES, b), BORDER_WIDTH + (BORDER_WIDTH + BUTTON_WIDTH) * 1, LIST_TOP + (BUTTON_HEIGHT + BORDER_HEIGHT) * 10, BUTTON_WIDTH);
