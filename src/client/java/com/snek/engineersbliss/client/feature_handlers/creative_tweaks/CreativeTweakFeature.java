...
public enum CreativeTweakFeature {
    ...
    NO_SIGN_GUI(CreativeTweakServerFeatureSet.NO_SIGN_GUI,
    ...
    OPEN_OBSTRUCTED_CONTAINERS(CreativeTweakServerFeatureSet.OPEN_OBSTRUCTED_CONTAINERS,
    ...
    PHASE_THROUGH_BLOCKS_FLY(CreativeTweakServerFeatureSet.PHASE_THROUGH_BLOCKS_FLY,
    ...
    PHASE_THROUGH_ENTITIES(CreativeTweakServerFeatureSet.PHASE_THROUGH_ENTITIES,
    ...
    DISABLE_FIRE_EFFECT(CreativeTweakServerFeatureSet.DISABLE_FIRE_EFFECT,
    ...
    DISABLE_FREEZING_EFFECT(CreativeTweakServerFeatureSet.DISABLE_FREEZING_EFFECT,
    ...
    FIX_HONEY_JUMP(CreativeTweakServerFeatureSet.FIX_HONEY_JUMP,
        () -> new UiTxt("Fix Honey Block jump"),
        () -> new Txt()
            .cat(new UiTxt("Lets you jump while standing on Honey Blocks.\n"))
            .cat(Notices.CREATIVE_MODE_ENTITIES_UNAFFECTED_NOTICE.get())
    ), //TODO
    DISABLE_HONEY_SLIDING(CreativeTweakServerFeatureSet.DISABLE_HONEY_SLIDING,
    ...
    DISABLE_WATER_SLOWDOWN(CreativeTweakServerFeatureSet.DISABLE_WATER_SLOWDOWN,
        () -> new UiTxt("Disable Water slowdown"),
        () -> new Txt()
            .cat(new UiTxt("Prevents you from being slowed down while walking through Water.\n"))
            .cat(Notices.CREATIVE_MODE_ENTITIES_UNAFFECTED_NOTICE.get())
    ),
    DISABLE_LAVA_SLOWDOWN(CreativeTweakServerFeatureSet.DISABLE_LAVA_SLOWDOWN,
        () -> new UiTxt("Disable Lava slowdown"),
        () -> new Txt()
            .cat(new UiTxt("Prevents you from being slowed down while walking through Lava.\n"))
            .cat(Notices.CREATIVE_MODE_ENTITIES_UNAFFECTED_NOTICE.get())
    ),
    DISABLE_COBWEB_SLOWDOWN(CreativeTweakServerFeatureSet.DISABLE_COBWEB_SLOWDOWN,
    ...
    DISABLE_LADDER_SLOWDOWN(CreativeTweakServerFeatureSet.DISABLE_LADDER_SLOWDOWN,
    ...
    DISABLE_VINES_SLOWDOWN(CreativeTweakServerFeatureSet.DISABLE_VINES_SLOWDOWN,
    ...
    DISABLE_TWISTING_VINES_SLOWDOWN(CreativeTweakServerFeatureSet.DISABLE_TWISTING_VINES_SLOWDOWN,
    ...
    DISABLE_WEEPING_VINES_SLOWDOWN(CreativeTweakServerFeatureSet.DISABLE_WEEPING_VINES_SLOWDOWN,
    ...
    DISABLE_SWEET_BERRIES_SLOWDOWN(CreativeTweakServerFeatureSet.DISABLE_SWEET_BERRIES_SLOWDOWN,
    ...
    DISABLE_ITEM_CHANGE_ANIMATION(CreativeTweakServerFeatureSet.DISABLE_ITEM_CHANGE_ANIMATION,
    ...
    DISABLE_HAND_SWING_ANIMATION(CreativeTweakServerFeatureSet.DISABLE_HAND_SWING_ANIMATION,
    ...
    DISABLE_DIMENSION_CHANGE_SCREEN(CreativeTweakServerFeatureSet.DISABLE_DIMENSION_CHANGE_SCREEN,
        () -> new UiTxt("Disable dimension change screen"),
        () -> new Txt()
            .cat(new UiTxt("Disables the loading screen that appears when changing dimensions.\n"))
            .cat(Notices.CREATIVE_MODE_PLAYERS_UNAFFECTED_NOTICE.get())
    ), //TODO
    DISABLE_WATER_FOV_CHANGE(CreativeTweakServerFeatureSet.DISABLE_WATER_FOV_CHANGE,
        () -> new UiTxt("Disable Water FOV"),
        () -> new Txt()
            .cat(new UiTxt("Stops you from having reduced FOV while inside Water.\n"))
            .cat(Notices.CREATIVE_MODE_PLAYERS_UNAFFECTED_NOTICE.get())
    ), //TODO
    DISABLE_WATER_OVERLAY(CreativeTweakServerFeatureSet.DISABLE_WATER_OVERLAY,
    ...
    DISABLE_LAVA_OVERLAY(CreativeTweakServerFeatureSet.DISABLE_LAVA_OVERLAY,
    ...
    DISABLE_NETHER_PORTAL_OVERLAY(CreativeTweakServerFeatureSet.DISABLE_NETHER_PORTAL_OVERLAY,
    ...
    private final CreativeTweakServerFeatureSet serverFeature;
    ...
    public CreativeTweakServerFeatureSet getServerFeature() { return serverFeature; }
    ...
    private CreativeTweakFeature(final CreativeTweakServerFeatureSet serverFeature, final Supplier<Txt> nameSupplier, final Supplier<Txt> detailsSupplier) {
