...
public class UiTxt extends Txt {
    ...
    public UiTxt(                                   final float scale) { this(   Fonts._default.medium, scale); }
    public UiTxt(final @NotNull String           s, final float scale) { this(s, Fonts._default.medium, scale); }
    public UiTxt(final @NotNull MutableComponent s, final float scale) { this(s, Fonts._default.medium, scale); }
    public UiTxt(final @NotNull Component        s, final float scale) { this(s, Fonts._default.medium, scale); }
