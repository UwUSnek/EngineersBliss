...
#define MINECRAFT
    ...
    #moj_import <engineersbliss:utils/render_3d.glsl>
    #moj_import <engineersbliss:effects/gravitational_lensing.glsl>
    #moj_import <engineersbliss:parts/edge_noise.glsl>
    #moj_import <engineersbliss:parts/falling_squares.glsl>
    #moj_import <engineersbliss:parts/ring_noise.glsl>
...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
    ...
    // Depth-sort and composite core/ring/disk/squares color layers
