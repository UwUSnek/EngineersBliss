...
public class CustomPlayerHeadItem extends StandingAndWallBlockItem {
    public CustomPlayerHeadItem(Block standing, Block wall, Direction attachDirection, Properties p) {
