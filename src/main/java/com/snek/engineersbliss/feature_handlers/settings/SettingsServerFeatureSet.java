...
public class SettingsServerFeatureSet extends __base_ServerFeatureSet {
    public static int BLOCK_SHADER_LIMIT_INFINITE = 0xC0F | 0xFEE;
    ...
    public static final ServerToggleFeature PAUSE_GAME_IN_MOD_SCREENS = INSTANCE.registerFeature(new ServerToggleFeature(
        "pause_game_in_mod_screens",
        true
    ));
    public static final ServerToggleFeature DEBUG_OVERLAYS = INSTANCE.registerFeature(new ServerToggleFeature(
        "debug_overlays",
        false
    ));
    ...
    public static final ServerToggleFeature BLOCK_SHADERS = INSTANCE.registerFeature(new ServerToggleFeature(
        "block_shaders",
        true
    ));
    ...
    public static final ServerToggleFeature STATUS_BAR_POSITION = INSTANCE.registerFeature(new ServerToggleFeature(
        "status_bar_position",
        false
    ));
    public static final ServerToggleFeature CHAT_HIDES_STATUS_BAR = INSTANCE.registerFeature(new ServerToggleFeature(
    ...
    public static final ServerToggleFeature METAL_PIPE_SOUNDS = INSTANCE.registerFeature(new ServerToggleFeature(
        "metal_pipe_sounds",
        false
    ));
}
